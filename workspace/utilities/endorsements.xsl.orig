...
<xsl:template match="data/endorsements-all" mode="main">
            ...
            <xsl:choose>
              <xsl:when test="count(images/item) = 1">
                <div class="image image-single">
                  <img class="img-responsive" src="{$root}/image/2/1500/900/2/0/uploads/images/{images/item/image/filename}" alt="{caption}"/>
                </div>
              </xsl:when>
              <xsl:otherwise>
                    ...
                    <div class="carousel-inner">
                      ...
                      <xsl:for-each select="images/item">
                        <div class="item">
                          ...
                          <img src="{$root}/image/2/1500/900/2/0/uploads/images/{image/filename}" alt="{caption}"/>
